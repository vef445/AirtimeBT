...
extension VPart: View where Top: View, Bottom: View, Handle: View {
    ...
    public init(@ViewBuilder top: () -> Top, @ViewBuilder bottom: () -> Bottom, @ViewBuilder handle: () -> Handle) {
        self.top = top()
        self.bottom = bottom()
        self.handle = handle()
    }
    ...
    ///    - bottom: Any type of View within a closure
    ///    - handle: Any type of View within a closure. The `Handle` is the view that the user will use to drag and resize the partitions.
    public init(pctSplit: CGFloat, @ViewBuilder top: () -> Top, @ViewBuilder bottom: () -> Bottom, @ViewBuilder handle: () -> Handle) {
...
extension VPart where Top: View, Bottom: View, Handle == Capsule {
    ...
    public init(@ViewBuilder top: () -> Top, @ViewBuilder bottom: () -> Bottom) {
        self.top = top()
        self.bottom = bottom()
        self.handle = Capsule()
    }
    ...
    /// - note
    ///  The `Handle` used here is a `Capsule` that is wider than it is tall.
    public init(pctSplit: CGFloat, @ViewBuilder top: () -> Top, @ViewBuilder bottom: () -> Bottom) {
        self.pctSplit = pctSplit
        self.top = top()
        self.bottom = bottom()
        self.handle = Capsule()
